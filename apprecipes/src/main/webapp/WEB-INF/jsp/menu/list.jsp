			...
			<div class="card">
				<div class="card-body">
					...
					<c:if test="${empty menus}">
						<div class="clearfix">
							<div class="float-start">
								<h5 class="page-title">Não existem consultorias
									cadastradas!</h5>
							</div>
							<div class="float-end">
								<a href="/consultancy/menu">
					...
					<c:if test="${not empty menus}">
						<div class="clearfix">
							<div class="float-start">
								<h5 class="page-title">Quantidade de consultorias
									cadastradas: ${menus.size()}!</h5>
							</div>
							<div class="float-end">
								<a href="/consultancy/menu">
									<button type="button" class="btn btn-primary btn-md">
								...
								<tbody>
									<c:forEach var="u" items="${menus}">
										<tr>
											...
											<td>${u.qtyHours}</td>
											<td>${u.cost}</td>
											<td><a href="#" class="action-icon"> <i
													class="mdi mdi-square-edit-outline"></i></a> <a
												href="/consultancy/menu/${u.id}/delete" class="action-icon">
